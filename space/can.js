...
import labelRaw from './assets/labels/*.jpg'
import canModelName from './assets/can.glb'

const labels = Object.values(labelRaw)
...
document.addEventListener('mousedown', event => {
  i++
  Label.material.map.image = new global.Image()
